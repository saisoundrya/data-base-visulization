...
public class TableDao {
	...
	public static Statement sconn() throws ClassNotFoundException, SQLException {
		...
		Connection conn = DriverManager.getConnection("jdbc:mysql://10.113.34.32:3306/world","ubuntu","Vikash@2001");
	...
	public static Statement hconn() throws ClassNotFoundException, SQLException {
		...
		Connection conn = DriverManager.getConnection("jdbc:hive2://10.113.34.32:10000", "ubuntu", "password");
	    Statement stmt = conn.createStatement();
	    return stmt;
	}
	...
	public static Statement cconn() throws ClassNotFoundException, SQLException {
		...
		Connection conn = DriverManager.getConnection("jdbc:cassandra://10.113.34.32:9160");
	    Statement stmt = conn.createStatement();
