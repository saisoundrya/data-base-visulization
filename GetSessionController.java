...
public class GetSessionController extends HttpServlet {
	...
	public static Statement sconn() throws ClassNotFoundException, SQLException {
		...
		conn = DriverManager.getConnection("jdbc:mysql://10.113.34.32:3306/world","ubuntu","Vikash@2001");
	...
	public static Statement hconn() throws ClassNotFoundException, SQLException {
		...
		conn = DriverManager.getConnection("jdbc:hive2://10.113.34.32:10000", "ubuntu", "password");
	    Statement stmt = conn.createStatement();
	    System.out.println("Connection success"); 
	    return stmt;
	}
	...
	public static Statement cconn() throws ClassNotFoundException, SQLException {
		...
		conn = DriverManager.getConnection("jdbc:cassandra://10.113.34.32:9160");
	    Statement stmt = conn.createStatement();
	    System.out.println("Connection success"); 
	    return stmt;
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("mysql".contentEquals(sess)) {
			try { 
				ResultSet srs = stmt.getMysqlStmt().executeQuery("SELECT table_schema, table_name FROM information_schema.tables WHERE table_schema NOT IN ( 'information_schema', 'performance_schema', 'mysql', 'result_webapp', 'hive', 'sys');");
				while (srs.next()) {
